...
local states=
{
    ...
    State{
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("dontstarve/creatures/rook/death", "tentacle")
    ...
    State{ 
        ...
        timeline=
        {
            TimeEvent(2*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/creatures/rook/explo") end),
...
return StateGraph("mechatentacle", states, events, "idle")
