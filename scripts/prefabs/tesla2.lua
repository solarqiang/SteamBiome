...
SetSharedLootTable( 'tesla_tree2',
{
    {'twigs',  1.0},
    {'log',    1.0},
	{'log',    1.0},
...
local function inspect_tree(inst)
    if inst:HasTag("burnt") then
       	STRINGS.CHARACTERS.GENERIC.DESCRIBE.TESLA2 = {	
			"View isn't quite as electrifying...",
		}
		STRINGS.CHARACTERS.WX78.DESCRIBE.TESLA2 = {	
		"BURNED.",
...
local function onload(inst, data)
	...
	local function fn(Sim)
		...
		inst.components.lootdropper:SetChanceLootTable('tesla_tree2')
...
STRINGS.NAMES.TESLA2 = "Tesla Tree"

return Prefab( "common/tesla2", fn, assets, prefabs)