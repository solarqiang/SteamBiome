...
STRINGS.NAMES.MECHALANCE = "Clockwork Lance"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.MECHALANCE = {	
	"Deadly Machine.",
}

STRINGS.CHARACTERS.WX78.DESCRIBE.MECHALANCE = {	
	"DEFENCE SYSTEM - FIRST LINE.",
}
